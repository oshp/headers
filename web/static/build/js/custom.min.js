...
$.ajax({url:"/total",data:$("form").serialize(),type:"GET",success:function(a){document.getElementById("sites_scannned").appendChild(document.createTextNode(a.total))},error:function(a){console.log(a)}});$("#xcto_donut").length&&$.ajax({url:"/xcto_chart",data:$("form").serialize(),type:"GET",success:function(a){for(var c=document.getElementById("xcto_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("xcto_donut"),
b).setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},calculable:!0,legend:{x:"center",y:"bottom",data:["nosniff","other"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"center",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},series:[{name:"x-content-type-options",type:"pie",radius:["35%","55%"],itemStyle:{normal:{label:{show:!0},labelLine:{show:!0}},emphasis:{label:{show:!0,
position:"center",textStyle:{fontSize:"14",fontWeight:"normal"}}}},data:[{value:a.nosniff,name:"nosniff"},{value:a.other,name:"other"}]}]})},error:function(a){console.log(a)}});$("#echart_pie").length&&$.ajax({url:"/sts_chart",data:$("form").serialize(),type:"GET",success:function(a){for(var c=document.getElementById("sts_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("echart_pie"),b).setOption({tooltip:{trigger:"item",
