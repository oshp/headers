...
$.fn.popover.Constructor.prototype.leave=function(b){var a=b instanceof this.constructor?b:$(b.currentTarget)[this.type](this.getDelegateOptions()).data("bs."+this.type),c,d;originalLeave.call(this,b);b.currentTarget&&(c=$(b.currentTarget).siblings(".popover"),d=a.timeout,c.one("mouseenter",function(){clearTimeout(d);c.one("mouseleave",function(){$.fn.popover.Constructor.prototype.leave.call(a,a)})}))};$("body").popover({selector:"[data-popover]",trigger:"click hover",delay:{show:50,hide:400}});
function gd(b,a,c){return(new Date(b,a-1,c)).getTime()}function onAddTag(b){alert("Added a tag: "+b)}function onRemoveTag(b){alert("Removed a tag: "+b)}function onChangeTag(b,a){alert("Changed a tag: "+a)}
...
$.ajax({url:"/pkp_chart",data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("pkp_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("mainb"),b).setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{data:["pin-sha256","max-age","includeSubDomains","report-uri"]},toolbox:{show:!1},calculable:!1,xAxis:[{type:"category",data:[""]}],yAxis:[{type:"value"}],series:[{name:"pin-sha256",
type:"bar",data:[a["pin-sha256"]]},{name:"max-age",type:"bar",data:[a["max-age"]]},{name:"includeSubDomains",type:"bar",data:[a.includeSubDomains]},{name:"report-uri",type:"bar",data:[a["report-uri"]]}]})},error:function(a){console.log(a)}});$("#echart_sonar").length&&$.ajax({url:"/xss_chart",data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("xss_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("echart_sonar"),
b).setOption({title:{text:"",subtext:""},tooltip:{trigger:"item"},legend:{orient:"vertical",x:"right",y:"bottom",data:[""]},toolbox:{show:!0,feature:{restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},polar:[{indicator:[{text:"0",max:10838},{text:"0; mode=block",max:10838},{text:"1",max:a["1"]},{text:"1; mode=block",max:10838},{text:"report",max:10838},{text:"other",max:10838}]}],calculable:!0,series:[{name:"",type:"radar",data:[{value:[a["0"],a["0-mode-block"],a["1"],a["1-mode-block"],
a.report,a.other],name:""}]}]})},error:function(a){console.log(a)}});$("#xfo").length&&$.ajax({url:"/xfo_chart",data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("xfo_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("xfo"),b).setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["deny","sameorigin","allow-from <uri>",
"other"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"x-frame-options",type:"pie",radius:[25,90],center:["50%",170],roseType:"area",x:"50%",max:40,sort:"ascending",data:[{value:a.deny,name:"deny"},{value:a.sameorigin,name:"sameorigin"},{value:a["allow-from"],name:"allow-from <uri>"},{value:a.other,name:"other"}]}]})},error:function(a){console.log(a)}});$("#xcto_donut").length&&
$.ajax({url:"/xcto_chart",data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("xcto_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("xcto_donut"),b).setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},calculable:!0,legend:{x:"center",y:"bottom",data:["nosniff","other"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",
width:"50%",funnelAlign:"center",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},series:[{name:"x-content-type-options",type:"pie",radius:["35%","55%"],itemStyle:{normal:{label:{show:!0},labelLine:{show:!0}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"14",fontWeight:"normal"}}}},data:[{value:a.nosniff,name:"nosniff"},{value:a.other,name:"other"}]}]})},error:function(a){console.log(a)}});$("#echart_pie").length&&$.ajax({url:"/sts_chart",
data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("sts_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));echarts.init(document.getElementById("echart_pie"),b).setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["max-age","includeSubDomains"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"left",
max:140}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"header option:",type:"pie",radius:"55%",center:["50%","48%"],data:[{value:a["max-age"],name:"max-age"},{value:a.includeSubDomains,name:"includeSubDomains"}]}]})},error:function(a){console.log(a)}});$("#echart_line").length&&$.ajax({url:"/csp_chart",data:$("form").serialize(),type:"POST",success:function(a){for(var c=document.getElementById("csp_total");c.firstChild;)c.removeChild(c.firstChild);
c.appendChild(document.createTextNode(a.total));init_DataTables(a);echarts.init(document.getElementById("echart_line"),b).setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Q1"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack",tiled:"Tiled"},type:["line","bar","stack","tiled"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:"script-src base-uri default-src object-src style-src img-src media-src frame-src child-src frame-ancestors font-src connect-src manifest-src form-action sandbox script-nonce plugin-types reflected-xss block-all-mixed-content upgrade-insecure-requests referrer report-uri report-to".split(" ")}],
yAxis:[{type:"value"}],series:[{name:"Q1",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[a["script-src"],a["base-uri"],a["default-src"],a["object-src"],a["style-src"],a["img-src"],a["media-src"],a["frame-src"],a["child-src"],a["frame-ancestors"],a["font-src"],a["connect-src"],a["manifest-src"],a["form-action"],a.sandbox,a["script-nonce"],a["plugin-types"],a["reflected-xss"],a["block-all-mixed-content"],a["upgrade-insecure-requests"],a.referrer,a["report-uri"],a["report-to"]]}]})},
