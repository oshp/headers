...
$("#echart_line").length&&$.ajax({url:"/csp_chart",data:$("form").serialize(),type:"GET",success:function(a){for(var c=document.getElementById("csp_total");c.firstChild;)c.removeChild(c.firstChild);c.appendChild(document.createTextNode(a.total));init_DataTables(a);echarts.init(document.getElementById("echart_line"),b).setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Q1"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack",
tiled:"Tiled"},type:["line","bar","stack","tiled"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data:"script-src base-uri default-src object-src style-src img-src media-src frame-src child-src frame-ancestors font-src connect-src manifest-src form-action sandbox script-nonce plugin-types reflected-xss block-all-mixed-content upgrade-insecure-requests referrer report-uri report-to".split(" ")}],yAxis:[{type:"value"}],
series:[{name:"Q1",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:[a["script-src"],a["base-uri"],a["default-src"],a["object-src"],a["style-src"],a["img-src"],a["media-src"],a["frame-src"],a["child-src"],a["frame-ancestors"],a["font-src"],a["connect-src"],a["manifest-src"],a["form-action"],a.sandbox,a["script-nonce"],a["plugin-types"],a["reflected-xss"],a["block-all-mixed-content"],a["upgrade-insecure-requests"],a.referrer,a["report-uri"],a["report-to"]]}]})},error:function(a){console.log(a)}})}}
$(document).ready(function(){init_sidebar();init_echarts()});
