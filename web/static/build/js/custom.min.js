...
$.ajax({url:"/total",data:$("form").serialize(),type:"GET",success:function(a){for(var b=document.getElementById("sites_scannned");b.firstChild;)b.removeChild(b.firstChild);b.appendChild(document.createTextNode(a.total).toLocaleString("pt-BR",{minimumFractionDigits:0}))},error:function(a){console.log(a)}});$("#xcto_donut").length&&$.ajax({url:"/xcto_chart",data:$("form").serialize(),type:"GET",success:function(a){for(var c=document.getElementById("xcto_total");c.firstChild;)c.removeChild(c.firstChild);
