...
def apply_caching(response):
    ...
    response.headers["Content-Security-Policy"] = "default-src https://oshp.bsecteam.com 'self'; script-src https://oshp.bsecteam.com https://js-agent.newrelic.com https://ssl.google-analytics.com https://ajax.cloudflare.com https://sentry.io https://cdn.ravenjs.com; style-src https://oshp.bsecteam.com https://sentry.io 'self'; img-src https://oshp.bsecteam.com https://sentry.io 'self'; font-src https://oshp.bsecteam.com 'self'; manifest-src https://oshp.bsecteam.com; object-src 'none'"
